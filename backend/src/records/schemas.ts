...
const chainTimestamp = z.number().int().nonnegative().safe();
...
export const VerificationReceiptSchema = z.strictObject({
  ...
  request_hash: hash,
  policy_hash: hash,
  request_anchor_tx: hash,
  request_anchor_block: chainTimestamp,
  observed_at: chainTimestamp,
  decision_deadline: chainTimestamp,
  verification_key_id: id,
...
export const DecisionSchema = z.strictObject({
  ...
  reason_code: id,
  institution_key_id: id,
  institution_signature: signature,
});
...
export const EvidenceBundleSchema = z.strictObject({
  ...
  verification_receipt: VerificationReceiptSchema,
